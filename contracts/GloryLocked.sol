...
contract GloryLocked is IGloryLocked, Ownable, ReentrancyGuard {
    ...
    // MAINNET config
    uint256 public unlockTime = 1682812800; // Sunday, April 30, 2023 00:00:00 AM
    ...
    function updateLockedTime(uint256 _newLocktime) external onlyOwner {
        unlockTime = _newLocktime;
    }
}
